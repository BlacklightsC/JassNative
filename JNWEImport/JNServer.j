library JNServer
    static if not REFORGED_MODE then
        ...
        native JNObjectCharacterResetScore takes string UserId returns nothing
            ...
            //JNGetUserRankType2(SSI)I
            //JNGetUserRankType1(SSI)I
        ...
        native JNObjectCharacterResetCharacter takes string UserId returns nothing
            ...
            //JNObjectCharacterServerConnectCheck()B
            //JNObjectCharacterPopGlobalMessageFormat(S)S
            //JNObjectCharacterGetUserScore(S)I
        ...
        native JNGetLoadCode takes string MapId, string UserId, string SecretKey, string Character returns string
            ...
            //JNRPGGetCharacterCount(SSS)I
            //JNRPGGetCharacterNameByIndex(SI)S
        ...
        native JNSetLog takes string MapId, string UserId, string SecretKey, string Character, string Version, string Loging returns string
            ...
            //JNMapServerLog(SSSS)S
            //JNMapServerLogUseType(SSSSS)S
            //JNSetLogUseType(SSSSSSS)S
            //JNUseUserRoleItem(SSSSS)B
            //JNUseUserRoleItemInfo(SSSS)S
        ...
        native JNServerPluginVersion takes nothing returns integer
            ...
            //JNScreenShotReg(SSSSS)B
            //JNPublicScreenShotReg(SSSSSS)B
            //JNReplayReg(SSSSS)V
            //JNCheckNameHack(S)B
            //JNPushReg(S)V
            //JNGetPushMessage()S
            //JNObjectScoreInit(SSSS)I
            //JNObjectScoreSave(SSSS)S
            //JNObjectScoreSet(SSI)V
            //JNObjectScoreAdd(SSI)V
            //JNObjectScoreGet(SS)I
    endif
    endlibrary